# CLAUDE.md - pawlands-cat-colony-idle
...
```text
C:\Users\Togszera\Desktop\pawlands-cat-colony-idle
```
...
O MVP atual deve ser um jogo de navegador/PWA sem login, backend, banco online ou multiplayer. React organiza telas/estado, Vite mantem o desenvolvimento leve e TypeScript protege os modelos de jogo.

Alternativas rejeitadas:

HTML/CSS/JS vanilla: pode limitar evolucao com varias telas. Supabase/backend customizado: rejeitados no MVP para evitar manutencao antes da necessidade real.
